						<form action="{{route('checkout-user')}}" method="POST">
							...
							<div class="form-group">
								...
								<input  type="tel" name="phone" placeholder="Số điện thoại" class="form-control" value="">
								@if($errors->has('phone'))
							...
							<div class="form-group">
								...
								<input type="radio" name="payment" value="COD"><span>Nhận hàng thanh toán(COD)</span>
								<input type="radio" name="payment" value="ATM" ><span>Chuyển khoản(ATM)</span>
